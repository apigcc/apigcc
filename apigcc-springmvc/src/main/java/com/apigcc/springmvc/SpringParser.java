...
public class SpringParser implements ParserStrategy {
    ...
    @Override
    public void onLoad() {
        Apigcc.getInstance().getTypeResolvers().addResolver(new SpringComponentTypeResolver());
        Apigcc.getInstance().getTypeResolvers().addNameResolver(new SpringComponentTypeResolver());
    }
